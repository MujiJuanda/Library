  ...
  $.ajax({
    ...
    success: function (data) {
      $("#jsGrid1").jsGrid({
        ...
        data: data,
        fields: [
          { name: "id_buku", type: "number", width: 50, title: "ID" },
          { name: "nama_buku", type: "text", width: 150, title: "Judul Buku" },
          { name: "nama_penerbit", type: "text", width: 150, title: "Penerbit" },
          { name: "buku_tglterbit", type: "text", width: 100, title: "Tanggal Terbit" },
          { name: "buku_jmlhalaman", type: "number", width: 80, title: "Jumlah Halaman" },
          { name: "buku_deskripsi", type: "text", width: 80, title: "Deskripsi Buku" },
          { name: "buku_harga", type: "number", width: 80, title: "Harga" },
          {
            name: "Aksi",
            type: "control",
            width: 100,
